...
], __WEBPACK_AMD_DEFINE_RESULT__ = function (_, Backbone, MainFileUploadView) {
...
var MainView = Backbone.View.extend({
    ...
    initialize: function() {
      this.fileMainUploadView = new MainFileUploadView();
    },

    render: function() {
      this.$el.html(this.template({}));

      //this.$("#loadViews").append(this.fileUploadView1.render().$el);
      //this.$("#loadViews").append(this.fileUploadView2.render().$el);
      return this;
    },

    compareResults: function() {
      console.log(this.fileUploadView1.data["file1"]);
      console.log(this.fileUploadView2.data["file2"]);
    }
    ...
    parseData: function() {
      ...
      Papa.parse(event.target.files[0], {
        ...
        complete: function(results) {
          that.data[that.id] = results.data;
        }
      });
    },
...
function parseData(fileDOM, callBack) {
    $(fileDOM).parse({
      config: {
        complete: function(results, file) {
          callBack(results.data, file, fileDOM);
        }
    }
    });
}
...
function processData(data, file, obj) {
  
  if (data && file) {
    mergedArray[$(obj).attr("id")] = data;
  }
